...
Веб-приложение, разработанное с использованием: **React**, **TypeScript**, **Redux** (для управления состоянием приложения), **Styled Components** (для стилизации компонентов с использованием CSS-in-JS), **Reactstrap** (набор компонентов Bootstrap для React), **React Hook Form** (для управления формами в React), **Yup** (библиотека для валидации данных) и **JSON Server** (инструмент для быстрого создания REST API из JSON-файлов).
